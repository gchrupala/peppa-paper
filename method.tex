...
for validation and 105--209 for testing. \todo{MN: maybe we should mention the 
total number of episodes somewhere earlier}
...
training and validation splits.\todo{GC: These numbers seem
  inconsistent between triplet/no triplet versions. MN: for traing and the 
  recall metrics, 
  segments should be 2.3s seconds, right?}
...
similarity (see also \Cref{fig:triplets_eval}\todo{MN: improve figure: text too 
small}).  More precisely, {\it triplet 
