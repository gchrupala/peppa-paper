...
\todo{We never compare to human performance, I suggest we remove this justification.}
For these reasons,
...
\end{equation}
where $A$ is the anchor, $P$ is the positive and $N$ is the negative video clip. The triplet
accuracy metric is inspired by the ABX score of \citet{schatz2016abx}. \todo{MN: 
...
performance to be at 1.0. For this metric we also quantify uncertainty by
...
%
%needs to succeed in either choosing a video
