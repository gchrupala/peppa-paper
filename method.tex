...
\begin{table}
  ...
  \begin{tabular}{lp{0.7\linewidth}}\toprule
    ...
    similarity        & Cosine similarity between representations, from fully trained model,  of two audio clips \\
    similarity\_init  & Cosine similarity between representations, from pre-trained-only model,  of two audio clips \\
