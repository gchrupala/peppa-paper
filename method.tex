...
\subsection{Dataset}
We use the dataset provided by \citet{papasarantopoulos2021narration} containing a set of 209 episodes of the
English-language version of {\it Peppa Pig}. In addition to the raw
videos,  we also use the annotations created by \citet{papasarantopoulos2021narration}.
...
words. \todo{This whole section could be shortened.}
