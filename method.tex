...
shows the sizes of the training and validation splits. The vocabulary size of 
the training data is 5580.
...
on the size and content of the candidate set.
%\footnote{Additionally, if in the 
%future
