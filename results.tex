...
We report results for the best performing model according to the performance metrics (ID 48, audio and video pretraining). The average targeted triplets accuracy is 0.679 . \Cref{fig:accuracy_targeted_triplets_nouns},  \Cref{fig:accuracy_targeted_triplets_verbs}, and \Cref{fig:accuracy_targeted_triplets_adjectives} show per-word accuracy for nouns, verbs, and adjectives, respectively. The vertical bars indicate the standard deviation as estimated using bootstrapping tests.
