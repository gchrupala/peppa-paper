...
model. \Cref{fig:recall_at_1_to_n} shows recall@$N$ for values of $N$
between 1 and 10.  In \Cref{sec:ablations} we investigate the impact
...
improvement for nouns (and no significant difference for verbs). We hypothesize 
