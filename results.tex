...
\textsc{wav2vec} module. The effect of this condition is shown in \Cref{fig:freeze_wav2vec}.
\begin{figure}[htb]
  \centering
...
For a model trained on \textsc{static} data, the performance is comparable with 
