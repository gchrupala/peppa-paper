...
minor and that performance is comparable.%\footnote{
However, we observe 
...
evaluation. We find that models which are 
...
correlation between log duration of clips and accuracy (Pearson $r= 0.69$, $p < 0.001$).
...
that most evaluation samples are clips of quite short, thus limiting
...
On the other end, performance for the concrete words such as \textit{ice}, \textit{box}, 
